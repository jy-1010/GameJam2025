...
void KeyConfig::Init(void)
{
	...
	Add(KeyConfig::CONTROL_TYPE::SERECT_LEFT, JOYPAD_BTN::LEFTBUTTON_LEFT);
	Add(KeyConfig::CONTROL_TYPE::SERECT_LEFT, JOYPAD_BTN::L_BUTTON);
	Add(KeyConfig::CONTROL_TYPE::SERECT_LEFT, JOYPAD_BTN::L_TRIGGER);
	Add(KeyConfig::CONTROL_TYPE::SERECT_LEFT, JOYPAD_STICK::L_STICK_LEFT);
	Add(KeyConfig::CONTROL_TYPE::SERECT_LEFT, JOYPAD_STICK::R_STICK_LEFT);
	Add(KeyConfig::CONTROL_TYPE::SERECT_RIFHT, KEY_INPUT_RIGHT);
	Add(KeyConfig::CONTROL_TYPE::SERECT_RIFHT, JOYPAD_BTN::LEFTBUTTON_RIGHT);
	Add(KeyConfig::CONTROL_TYPE::SERECT_RIFHT, JOYPAD_BTN::R_BUTTON);
	Add(KeyConfig::CONTROL_TYPE::SERECT_RIFHT, JOYPAD_BTN::R_TRIGGER);
	Add(KeyConfig::CONTROL_TYPE::SERECT_RIFHT, JOYPAD_STICK::L_STICK_RIGHT);
	Add(KeyConfig::CONTROL_TYPE::SERECT_RIFHT, JOYPAD_STICK::R_STICK_RIGHT);

	Add(KeyConfig::CONTROL_TYPE::DECISION, KEY_INPUT_SPACE);
	Add(KeyConfig::CONTROL_TYPE::DECISION, KeyConfig::JOYPAD_BTN::RIGHTBUTTON_DOWN);
	Add(KeyConfig::CONTROL_TYPE::DECISION, KeyConfig::JOYPAD_BTN::RIGHTBUTTON_LEFT);
	Add(KeyConfig::CONTROL_TYPE::DECISION, KeyConfig::JOYPAD_BTN::RIGHTBUTTON_RIGHT);
	Add(KeyConfig::CONTROL_TYPE::DECISION, KeyConfig::JOYPAD_BTN::RIGHTBUTTON_TOP);

	Add(KeyConfig::CONTROL_TYPE::EXITDECISION, KEY_INPUT_SPACE);

	Add(KeyConfig::CONTROL_TYPE::END, KEY_INPUT_ESCAPE);
	Add(KeyConfig::CONTROL_TYPE::JUMP, KeyConfig::JOYPAD_BTN::RIGHTBUTTON_RIGHT);
	Add(KeyConfig::CONTROL_TYPE::JUMP, KEY_INPUT_D);
	Add(KeyConfig::CONTROL_TYPE::JUMP, KeyConfig::JOYPAD_BTN::RIGHTBUTTON_TOP);
	Add(KeyConfig::CONTROL_TYPE::JUMP, KEY_INPUT_S);
	Add(KeyConfig::CONTROL_TYPE::JUMP, KeyConfig::JOYPAD_BTN::RIGHTBUTTON_LEFT);
	Add(KeyConfig::CONTROL_TYPE::JUMP, KEY_INPUT_A);
}
